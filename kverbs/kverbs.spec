%define distversion %( perl -e 'Creating /home/nicolas/src/kverbs-0.1/kverbs.spec...=\<\>;/(\d+)\.(\d)\.?(\d)?/; print "".(||0)' /etc/*-release)
Name: kverbs
Summary: KVerbs -- Some description
Version: 0.1
Release: %{_vendor}_%{distversion}
Copyright: GPL
Group: X11/KDE/Utilities
Source: ftp://ftp.kde.org/pub/kde/unstable/apps/utils/%{name}-%{version}.tar.gz
Packager: Nicolas Bellm <nbellm@gmx.de>
